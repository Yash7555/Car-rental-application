...
<?php }} ?>
    ...
    var tenDaysFromNowFormatted = tenDaysFromNow.toISOString().split('T')[0];

    // Set the maximum selectable date for the date picker to 10 days from today
    document.getElementById("datePicker").setAttribute("max", tenDaysFromNowFormatted);
</script>
      <!--Side-Bar-->
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              <input type="date" class="form-control" name="fromdate" min="2024-04-30" max="2024-05-02"  required>
            </div>
            <div class="form-group">
            <input type="date" class="form-control" id="datePicker"  min="2024-04-30"  min="<?php echo date('Y-m-d'); ?>" max="" >
            ...
            <div class="form-group">
              <input type='text' class="form-control" name="message" maxlength="16" placeholder="Debit/Credit card Number" required>
            </div>
            <div class="form-group">
              <input type='text' class="form-control" name="message" placeholder="Expiry Date (14/28)" required>
            </div>
            <div class="form-group">
              <input type='text' class="form-control" name="message" maxlength="3" placeholder="CVV" required>
            </div>
